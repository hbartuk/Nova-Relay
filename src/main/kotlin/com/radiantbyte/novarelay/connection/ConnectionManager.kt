...
class ConnectionManager(
    ...
    private suspend fun attemptConnection(
        ...
        val bootstrap = Bootstrap()
            ...
            .option(RakChannelOption.RAK_REMOTE_GUID, clientConfig.guid)
            ...
            .option(RakChannelOption.RAK_TIME_BETWEEN_SEND_CONNECTION_ATTEMPTS_MS, config.timeBetweenConnectionAttempts.toInt())
            ...
            .option(RakChannelOption.RAK_MTU_SIZES, clientConfig.mtuSizes)
        ...
        val timeoutJob = CoroutineScope(Dispatchers.IO).launch {
            delay(config.connectionTimeout + 5000)
    ...
    private fun shouldNotRetry(exception: Exception): Boolean {
        ...
        return when {
            ...
            message.contains("no free incoming connections") -> true
